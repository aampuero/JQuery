$(function() {
    /**
     * Counter to register the number
     */
    var contador;
    ...
    /**
     * input fade banner carrers information
     */
    $('#carrera').focus(function() {
    ...
    */
    ...
    /**
     * registering studient
     * @return {json} this will be registering the studens
     */
    ...
    /**
     * show students
     * @return {this will add the students on the table} 
     */
    function registrarMostrar() {
        ...
        for (var i = 0; i < localStorage.length; i++) {
            ...
            tabla += '<td><button class="btn" onclick="editarEstudiantes(\'' + estudiantes.codigo + '\');">Editar</button></td>';
            tabla += '<td><button class="btn" onclick="eliminarEstudiantes(\'' + estudiantes.codigo + '\');">Eliminar</button></td>';
            tabla += '</tr>';
        }
    ...
    /**
     * allows you to edit the existing studens
     */
    window.editarEstudiantes = function(codigo) {
            ...
            for (var i = 0; i < localStorage.length; i++) {
                ...
                $('#apellidos').val(estudiantes.apellidos);
                $('#carrera').val(estudiantes.carrera);
                $('#nota').val(estudiantes.notas);
            }
        }
        /**
         * alloes you to remove the students
         */
